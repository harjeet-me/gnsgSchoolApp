...
export class ASPathComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.aSPathService
        ...
        .subscribe(
          (res: HttpResponse<IASPath[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInASPaths(): void {
    this.eventSubscriber = this.eventManager.subscribe('aSPathListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IASPath[] | null, headers: HttpHeaders, page: number): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    this.ngbPaginationPage = this.page;
    this.router.navigate(['/as-path'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
